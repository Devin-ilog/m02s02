//LAÇO FOR
var array = ["Gustavo", "Fabiane", "Rayane", "Tulio", "Matheus"];
console.log(array.indexOf("Fabiane")); // Para saber qual a posição do item "Fabiane"
...
// WHILE
// Foi feito um exercício em aula